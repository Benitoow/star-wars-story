...
const FACTIONS = [
  { id: 'jedi',       name: 'Ordre Jedi',            sub: 'Gardiens de la paix',      color: '#4FC3F7', svg: 'svg/lightsaber-svgrepo-com.svg', members: '10 000+' },
  { id: 'sith',       name: 'Ordre Sith',            sub: 'Maîtres des ténèbres',     color: '#FF1744', svg: 'svg/starwars-sith-svgrepo-com.svg', members: '2-10' },
  { id: 'empire',     name: 'Empire Galactique',     sub: 'Paix par l\'ordre',        color: '#e0e0e0', svg: 'svg/noun-storm-trooper-49992.svg', members: 'Multiples systèmes' },
  { id: 'rebels',     name: 'Alliance Rebelle',      sub: 'Espoir de la galaxie',     color: '#FF6B35', svg: 'svg/millennium-falcon-svgrepo-com.svg', members: 'Variable' },
  { id: 'republic',   name: 'République Galactique', sub: 'Démocratie & justice',    color: '#81D4FA', svg: 'svg/brand-galactic-republic-svgrepo-com.svg', members: 'Systèmes fondateurs' },
  { id: 'mandalore',  name: 'Mandalorians',          sub: 'C\'est la voie',           color: '#A5D6A7', svg: 'svg/mandalorian-svgrepo-com.svg', members: 'Nucléus' },
  { id: 'first_order', name: 'Premier Ordre',         sub: 'Héritage Impérial',        color: '#B71C1C', svg: 'svg/Emblem_of_the_First_Order.svg', members: 'Militaire' },
  { id: 'hutt',       name: 'Cartel Hutt',           sub: 'Le crime paie',            color: '#FFE082', svg: 'svg/Desilijic_clan_vector.svg', members: 'Territoires neutres' },
  { id: 'neutral',    name: 'Indépendant',           sub: 'Libre de tout lien',       color: '#bdbdbd', svg: 'svg/alone-characterized-embodied-svgrepo-com.svg', members: 'Illimité' },
];
...
const ROLES = [
  {
    ...
    color: '#4FC3F7',
    svg: 'svg/luke-skywalker-lightsaber-svgrepo-com.svg',
    faction: 'jedi',
  ...
  },
  {
    ...
    color: '#81D4FA',
    svg: 'svg/jedi-order-svgrepo-com.svg',
    faction: 'jedi',
  ...
  },
  {
    ...
    color: '#B3E5FC',
    svg: 'svg/lightsaber-svgrepo-com.svg',
    faction: 'jedi',
  ...
  },
  {
    ...
    color: '#FF1744',
    svg: 'svg/starwars-sith-svgrepo-com.svg',
    faction: 'sith',
  ...
  },
  {
    ...
    color: '#D50000',
    svg: 'svg/SithEmblem-Traced-TORkit.svg',
    faction: 'sith',
  ...
  },
  {
    ...
    color: '#A5D6A7',
    svg: 'svg/mandalorian-svgrepo-com.svg',
    faction: 'mandalore',
  ...
  },
  {
    ...
    color: '#FFE082',
    svg: 'svg/scifi-starwars-boba-fett-svgrepo-com.svg',
    faction: 'neutral',
  ...
  },
  {
    ...
    color: '#FFAB40',
    svg: 'svg/millennium-falcon-svgrepo-com.svg',
    faction: 'neutral',
  ...
  },
  {
    ...
    color: '#FF8F00',
    svg: 'svg/alone-characterized-embodied-svgrepo-com.svg',
    faction: 'neutral',
  ...
  },
  {
    ...
    color: '#BDBDBD',
    svg: 'svg/noun-storm-trooper-49992.svg',
    faction: 'republic',
  ...
  },
  {
    ...
    color: '#ECEFF1',
    svg: 'svg/Emblem_of_the_First_Galactic_Empire.svg',
    faction: 'empire',
  ...
  },
  {
    ...
    color: '#CE93D8',
    svg: 'svg/brand-galactic-republic-svgrepo-com.svg',
    faction: 'republic',
...
const I18N = {
  ...
  en: {
    ...
    // removed narrationLang 'Narration language',
    era: 'Era',
    faction: 'Faction',
    role: 'Role',
  ...
  es: {
    ...
    // removed narrationLang 'Idioma de narración',
    era: 'Era',
    faction: 'Facción',
    role: 'Rol',
  ...
  de: {
    ...
    // removed narrationLang 'Erzählsprache',
    era: 'Ära',
    faction: 'Fraktion',
    role: 'Rolle',
  ...
  it: {
    ...
    // removed narrationLang 'Lingua di narrazione',
    era: 'Era',
    faction: 'Fazione',
    role: 'Ruolo',
  ...
  pt: {
    ...
    // removed narrationLang 'Idioma da narração',
    era: 'Era',
    faction: 'Facção',
    role: 'Papel',
  ...
  ja: {
    ...
    // removed narrationLang 'ナレーション言語',
    era: '時代',
    faction: '勢力',
    role: '役割',
    premise: '出発点',
